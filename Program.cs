...
var Rolename = Environment.GetEnvironmentVariable("DB_RoleNAME");
var password = Environment.GetEnvironmentVariable("DB_PASSWORD");

var connectionString = $"server={host};port={port};database={databaseName};uid={Rolename};password={password}";
